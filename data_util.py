...
class Data(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask  = cv2.imread(self.cfg.datapath+'/Masks/' +name+'.png', 0).astype(np.float32)
        shape = mask.shape
    ...
    def collate(self, batch):
        ...
        size = [192, 256, 320, 384, 448][np.random.randint(0, 5)]
        # size = [320, 384, 448][np.random.randint(0,3)]
